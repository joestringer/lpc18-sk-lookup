...
stateful firewall case and a description of the use of the new functionality
for load-balancing. Finally, we conclude and assess the position of this work.
...
\todo{Early in the stack, figure out whether the traffic is destined for a
local process and if so, pass. Otherwise, perform load-balancing to another
node where the traffic is destined for.}
